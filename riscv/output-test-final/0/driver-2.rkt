...
(send search superoptimize encoded-code (send printer encode-live '(1)) "output-test-final/0/driver-2" 3600 4 #:assume #f #:input-file #f #:start-prog #f #:fixed-length #t #:prefix encoded-prefix #:postfix encoded-postfix)
